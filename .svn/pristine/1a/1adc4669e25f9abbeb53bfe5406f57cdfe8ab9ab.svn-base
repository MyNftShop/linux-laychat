...
insert into `snake_chatuser`(`id`,`username`,`pwd`,`groupid`,`status`,`sign`,`avatar`) values('1','纸飞机','21232f297a57a5a743894a0e4a801fc3','2','outline','在深邃的编码世界，做一枚轻盈的纸飞机','http://cdn.firstlinkapp.com/upload/2016_6/1465575923433_33812.jpg');
